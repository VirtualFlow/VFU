...
def run_pose_prediction_program(program_choice, center_x, center_y, center_z, size_x, size_y, size_z, exhaustiveness, smi, receptor, chimera_path = '', dock6_path = '', ref_lig = '', seed_path = '', mdock_path = '', molegro_path = '', covalent_bond_constraints='', receptor_2=''): 
    ...
    elif  program_choice == 'qvina_w_gpu' or program_choice == 'qvina_gpu' or program_choice == 'AutodockVina_1.2' or program_choice == 'AutodockVina_1.1.2' or program_choice == 'idock' or program_choice == 'qvina' or program_choice == 'qvina-w' or program_choice == 'vina' or program_choice == 'vina_carb' or program_choice == 'vina_xb' or program_choice == 'gwovina'  or program_choice == 'PSOVina': 
        command.append('--receptor')
        command.append(receptor)
    
    
    # Assign the right ligand for docking
    if  program_choice == 'qvina_w_gpu' or program_choice == 'qvina_gpu' or program_choice == 'AutodockVina_1.2' or program_choice == 'AutodockVina_1.1.2' or program_choice == 'idock' or program_choice == 'qvina' or program_choice == 'smina' or program_choice == 'gnina' or program_choice == 'qvina-w' or program_choice == 'qvina-w' or program_choice == 'vina_carb' or program_choice == 'vina_xb' or program_choice == 'gwovina' or program_choice == 'PSOVina':
    ...
    for lig_ in lig_locations: 
        ...
        if program_choice == 'qvina_w_gpu' or program_choice == 'qvina_gpu' or program_choice == 'AutodockVina_1.2' or program_choice == 'AutodockVina_1.1.2' or program_choice == 'idock' or  program_choice == 'qvina' or program_choice == 'qvina-w' or program_choice == 'vina' or program_choice == 'vina_carb' or program_choice == 'vina_xb' or program_choice == 'gwovina' or program_choice == 'PSOVina': 
        ...
        if program_choice == 'qvina_w_gpu' or program_choice == 'qvina_gpu' or program_choice == 'AutodockVina_1.2' or program_choice == 'AutodockVina_1.1.2' or program_choice == 'qvina' or program_choice == 'qvina-w' or program_choice == 'vina' or program_choice == 'vina_carb' or program_choice == 'vina_xb' or program_choice == 'gwovina' or program_choice == 'PSOVina': 

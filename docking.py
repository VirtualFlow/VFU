...
# ./executables/qvina --receptor ./config/prot_1.pdb --ligand ./ligands/1.pdbqt --exhaustiveness 10 --center_x -16 --center_y 145 --center_z 27 --size_x 10 --size_y 10 --size_z 10 --out ./outputs/pose_1.pdb --log ./outputs/log_1.txt
    
    # Running QVina: 
    command = [ './executables/qvina',                       # Docking executable
               
                '--receptor', './config/prot_1.pdb',                 # Defining the receptor
                '--ligand', './ligands/{}'.format(lig_),           # Defining the ligand to be docked
                ...
                '--out', './outputs/pose_{}.pdbqt'.format(lig_.split('.')[0]),     # Path of output poses 
                '--log', './outputs/log_{}.txt'.format(lig_.split('.')[0])    # Path of output log file 
                ]
        
    # TODO: Output file for smina & qvina: pdqt (line 85!!!!!)

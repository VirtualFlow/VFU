...
# Parameters:  
program_choice = 'qvina-w' # smina/qvina/qvina-w
...
elif program_choice == 'qvina' or program_choice == 'qvina-w': 
    command.append('--receptor')
    command.append(receptor)


# Assign the right ligand for docking
if program_choice == 'qvina' or program_choice == 'smina' or program_choice == 'qvina-w':
...
for lig_ in lig_locations: 
    ...
    if program_choice == 'qvina' or program_choice == 'qvina-w': 

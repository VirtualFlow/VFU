...
from utils import run_glide_docking, run_rosetta_docking, run_mdock_docking, run_seed_docking, run_nnscore2, run_rf_scoring
...
is_selfies     = False 
is_peptide     = False
program_choice = 'rf-score' # smina/qvina/qvina-w/vina/vina_carb/vina_xb/gwovina/PLANTS/autodock_gpu/autodock_cpu/EquiBind/rDock/gnina/ledock/idock
